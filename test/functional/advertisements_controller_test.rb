...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { ad_author_name: @advertisement.ad_author_name, ad_discription: @advertisement.ad_discription, ad_name: @advertisement.ad_name, user_id: @advertisement.user_id }
    end
  ...
  test "should update advertisement" do
    put :update, id: @advertisement, advertisement: { ad_author_name: @advertisement.ad_author_name, ad_discription: @advertisement.ad_discription, ad_name: @advertisement.ad_name, user_id: @advertisement.user_id }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
